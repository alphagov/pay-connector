...
| `card_type`              |           | The card type used for this payment  |
| `name_on_card`           |           | The card card holder name of this payment       |
| `email_address`          |           | The email address of the user of this payment       |
| `card_expiry`            |           | The expiry date of this card       |
| `last_four_digits`       |           | The last four digits of this card        |
| `first_six_digits`       |           | The first six digits of this card        |
