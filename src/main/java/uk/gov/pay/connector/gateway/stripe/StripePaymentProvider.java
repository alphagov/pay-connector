...
import uk.gov.pay.connector.gateway.stripe.handler.StripePaymentIntentCreator;
...
public class StripePaymentProvider implements PaymentProvider {
    ...
    public StripePaymentProvider(GatewayClientFactory gatewayClientFactory,
        ...
        stripePaymentIntentCreator = new StripePaymentIntentCreator(client, stripeGatewayConfig, configuration, jsonObjectMapper);
    }
    ...
    public void createPaymentIntent(ChargeEntity chargeEntity) {
        StripePaymentIntentResponse stripePaymentIntentResponse = stripePaymentIntentCreator.createPaymentIntent(chargeEntity);
        chargeEntity.setGatewayTransactionId(stripePaymentIntentResponse.getId());
        chargeEntity.setClientSecret(stripePaymentIntentResponse.getClientSecret());
    }
