...
public class WorldpayRecurringCustomerInitiatedLegacy3dsEligibleAuthoriseRequestFactory {
    
    private final WorldpayAuthoriseRequestFactoryHelper helper;
    
    public WorldpayRecurringCustomerInitiatedLegacy3dsEligibleAuthoriseRequestFactory(WorldpayAuthoriseRequestFactoryHelper helper) {
        this.helper = helper;
    }

    public WorldpayRecurringCustomerInitiatedLegacy3dsEligibleAuthoriseRequest create(CardAuthorisationGatewayRequest request) {
