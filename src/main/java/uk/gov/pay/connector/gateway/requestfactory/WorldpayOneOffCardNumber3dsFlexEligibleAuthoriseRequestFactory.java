...
public class WorldpayOneOffCardNumber3dsFlexEligibleAuthoriseRequestFactory {
    
    private final WorldpayAuthoriseRequestFactoryHelper helper;
    
    public WorldpayOneOffCardNumber3dsFlexEligibleAuthoriseRequestFactory(WorldpayAuthoriseRequestFactoryHelper helper) {
        this.helper = helper;
    }

    public WorldpayOneOffCardNumber3dsFlexEligibleAuthoriseRequest create(CardAuthorisationGatewayRequest request) {
