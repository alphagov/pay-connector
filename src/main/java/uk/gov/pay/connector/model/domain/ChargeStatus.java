...
public enum ChargeStatus {
    ...
    // Todo: once we have the retrying mechanism in place, CAPTURE_APPROVED should represent EXTERNAL_SUCCESS
    CAPTURE_APPROVED("CAPTURE APPROVED", EXTERNAL_ERROR_GATEWAY),
    // TO BE CHANGED TO EXTERNAL_SUCCESS when we move capture to be async
