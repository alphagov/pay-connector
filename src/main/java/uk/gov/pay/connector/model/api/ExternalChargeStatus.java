...
public enum ExternalChargeStatus {
    ...
    EXT_IN_PROGRESS("IN PROGRESS", ENTERING_CARD_DETAILS, AUTHORISATION_SUBMITTED, AUTHORISATION_READY, AUTHORISATION_SUCCESS, READY_FOR_CAPTURE),
    EXT_SUCCEEDED("SUCCEEDED", CAPTURED, CAPTURE_SUBMITTED),
    EXT_FAILED("FAILED", AUTHORISATION_REJECTED, CAPTURE_ERROR, AUTHORISATION_ERROR),
