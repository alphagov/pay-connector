...
public enum ExternalChargeStatus {
    ...
    EXT_IN_PROGRESS("IN PROGRESS", ENTERING_CARD_DETAILS, AUTHORISATION_SUBMITTED, AUTHORISATION_SUCCESS, CAPTURE_SUBMITTED),
    EXT_SUCCEEDED("SUCCEEDED", CAPTURED),
    EXT_FAILED("FAILED", AUTHORISATION_REJECTED, CAPTURE_UNKNOWN),
