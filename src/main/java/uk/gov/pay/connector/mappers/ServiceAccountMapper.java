...
public class ServiceAccountMapper implements ResultSetMapper<ServiceAccount> {
    ...
    @Override
    public ServiceAccount map(int i, ResultSet resultSet, StatementContext statementContext) throws SQLException {
        ...
        try {
            ...
            return new ServiceAccount(gatewayAccountId, paymentGatewayName, credentialsMap);
        } catch (IOException e) {
