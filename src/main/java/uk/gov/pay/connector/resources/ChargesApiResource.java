        ...
        return ApiValidators
                ...
                .orElseGet(() -> {
                    ChargeSearchParams searchParams = new ChargeSearchParams()
                            ...
                            .withFirstDigitsCardNumber(firstDigitsCardNumber != null ? FirstDigitsCardNumber
                                    .of(firstDigitsCardNumber) : null)
        ...
        return ApiValidators
                ...
                .orElseGet(() -> {
                    ChargeSearchParams searchParams = new ChargeSearchParams()
                            ...
                            .withFirstDigitsCardNumber(firstDigitsCardNumber != null ? FirstDigitsCardNumber.of(firstDigitsCardNumber) : null)
                            .withReferenceLike(reference != null ? ServicePaymentReference.of(reference) : null)
                            .withCardBrands(removeBlanks(cardBrands))
                            .withFromDate(parseDate(fromDate))
                            .withToDate(parseDate(toDate))
