...
public class TransactionsPaginationResponseBuilder {
    ...
    public TransactionsPaginationResponseBuilder(ChargeSearchParams searchParams, UriInfo uriInfo) {
    ...
    public TransactionsPaginationResponseBuilder withTransactionResponses(List<TransactionResponse> transactionResponses) {
        this.transactionResponses = transactionResponses;
        return this;
    }

    public TransactionsPaginationResponseBuilder withTotalCount(Long total) {
    ...
    public Response buildResponse() {
        ...
        HalRepresentation.HalRepresentationBuilder halRepresentationBuilder = HalRepresentation.builder()
                .addProperty("results", transactionResponses)
                .addProperty("count", transactionResponses.size())
