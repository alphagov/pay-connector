...
public class CardDetailsResource {
    ...
    public Response createNewCharge(@PathParam("chargeId") long chargeId, Map<String, Object> cardDetails, @Context UriInfo uriInfo) throws PayDBIException {
        ...
        URI newLocation = uriInfo.getBaseUriBuilder().path("/todo").build();
