...
public class ConnectorModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(ChargeFrontendUrlHelper.class).in(Singleton.class);
        bind(AdyenCredentialsHelper.class).in(Singleton.class);
        bind(AdyenMerchantAccountHelper.class).in(Singleton.class);
        bind(WorldpayAuthoriseCredentialsHelper.class).in(Singleton.class);
        bind(WorldpayAuthoriseDescriptionHelper.class).in(Singleton.class);
