...
import uk.gov.pay.connector.charge.exception.MotoNotAllowedForGatewayAccountExceptionMapper;
...
public class ConnectorApp extends Application<ConnectorConfiguration> {
    ...
    public void run(ConnectorConfiguration configuration, Environment environment) {
        ...
        environment.jersey().register(new MotoNotAllowedForGatewayAccountExceptionMapper());
