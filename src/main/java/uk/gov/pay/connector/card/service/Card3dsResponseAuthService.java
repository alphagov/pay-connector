...
import static uk.gov.pay.connector.card.service.Card3dsResponseAuthService.TypeOf3dsRequest.NONE_OF_THE_ABOVE;
import static uk.gov.pay.connector.card.service.Card3dsResponseAuthService.TypeOf3dsRequest.WORLDPAY_3DS_CLASSIC;
import static uk.gov.pay.connector.card.service.Card3dsResponseAuthService.TypeOf3dsRequest.WORLDPAY_3DS_FLEX;
...
public class Card3dsResponseAuthService {
    ...
    public Card3dsResponseAuthService(PaymentProviders providers,
                                      ...
                                      CardService cardService, AuthorisationService authorisationService,
    ...
    private void processGateway3DSecureResponse(String chargeExternalId, ChargeStatus oldChargeStatus, Gateway3DSAuthorisationResponse operationResponse, Auth3dsResult auth3dsResult) {
        ...
        ChargeEntity updatedCharge = cardService.updateChargePost3dsAuthorisation(
                chargeExternalId,
                newStatus,
                AUTHORISATION_3DS,
