...
public class GatewayAccountResponse {
    ...
    public GatewayAccountResponse(GatewayAccountEntity gatewayAccountEntity) {
        ...
        this.sendPayerEmailToGateway = gatewayAccountEntity.getCardConfigurationEntity().isSendPayerEmailToGateway();
        this.sendReferenceToGateway = gatewayAccountEntity.getCardConfigurationEntity().isSendReferenceToGateway();
        this.sendPayerIpAddressToGateway = gatewayAccountEntity.getCardConfigurationEntity().isSendPayerIpAddressToGateway();
