...
class WalletAuthoriseServiceTest extends CardServiceTest {
    ...
    void setUp() {
        ...
        lenient().when(mockWalletAuthorisationDataToAuthCardDetailsConverter.convert(any(WalletPaymentInfo.class), nullable(CardExpiryDate.class))).thenReturn(mockAuthCardDetails);
    ...
    void doAuthoriseCard_GooglePay_shouldRespondAuthorisationSuccess() throws Exception {
        ...
        WorldpayGooglePayAuthRequest authorisationData =
