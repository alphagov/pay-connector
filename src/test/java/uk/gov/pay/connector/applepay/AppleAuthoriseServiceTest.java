...
public class AppleAuthoriseServiceTest extends CardServiceTest {
    ...
    @Mock
    private ApplePayAuthoriser mockApplePayAuthoriser;

    @Mock
    private Counter mockCounter;

    private AppleAuthoriseService appleAuthoriseService;
    private AppleDecryptedPaymentData validApplePayDetails = AuthUtils.ApplePay.buildDecryptedPaymentData("Mr. Payment", "mr@payment.test", "4242424242424242");
    ...
    public void setUpCardAuthorisationService() {
        ...
        when(mockedProviders.getAppleAuthoriserFor(any())).thenReturn(mockApplePayAuthoriser);
    ...
    private void setupPaymentProviderMock(GatewayError gatewayError) {
        ...
        GatewayResponse authorisationResponse = gatewayResponseBuilder
                ...
                .build();
        when(mockApplePayAuthoriser.authorise(any())).thenReturn(authorisationResponse);
    }
    ...
    public void doAuthorise_shouldRespondAuthorisationSuccess_overridingGeneratedTransactionId() {
        ...
        when(mockedProviders.getAppleAuthoriserFor(charge)).thenReturn(mockApplePayAuthoriser);
    ...
    private void providerWillRespondToAuthoriseWith(GatewayResponse value) {
        when(mockApplePayAuthoriser.authorise(any())).thenReturn(value);
        when(mockedProviders.getAppleAuthoriserFor(charge)).thenReturn(mockApplePayAuthoriser);
    }
