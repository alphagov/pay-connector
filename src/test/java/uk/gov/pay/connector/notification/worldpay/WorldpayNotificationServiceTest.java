...
import uk.gov.pay.connector.notification.ChargeNotificationProcessor;
import uk.gov.pay.connector.notification.RefundNotificationProcessor;
...
public class WorldpayNotificationServiceTest {
    ...
    public void givenARefundNotification_refundNotificationProcessorInvokedWithNotificationAndCharge() {
        ...
        verify(mockChargeNotificationProcessor, never()).invoke(any(), any(), eq(CAPTURED), any());
    ...
    public void ifPayloadNotValidXml_shouldIgnoreNotificatoin() {
        ...
        verify(mockChargeNotificationProcessor, never()).invoke(anyString(), any(), eq(CAPTURED), any());
        verify(mockRefundNotificationProcessor, never()).invoke(any(), any(), any(), any());
    }
}
