        ...
        @Nested
            ...
            void validRequest_shouldUpdateCredentials_andReturn200() {
                ...
                app.givenSetup()
                        ...
                        .post(format(CREATE_CREDENTIALS_BY_SERVICE_ID_URL, VALID_SERVICE_ID, TEST))
                        .then()
                        .statusCode(OK.getStatusCode())
        ...
        class PatchGatewayAccountCredentials {
            ...
            void forValidRequest_shouldUpdateCredentials_andReturn200() {
                ...
                app.givenSetup()
                    ...
                    .patch(format(PATCH_CREDENTIALS_BY_SERVICE_ID_URL, VALID_SERVICE_ID, TEST, credentialsId))
                    .then()
                    .statusCode(200)
                    .body("$", hasKey("credentials"))
                    .body("credentials.stripe_account_id", is("new-account-id"))
                ...
                app.givenSetup()
                        .body(toJson(singletonList(
                                Map.of("op", "replace",
                                        "path", "credentials",
                                        "value", newCredentials))))
                        .patch(format(PATCH_CREDENTIALS_BY_SERVICE_ID_URL, VALID_SERVICE_ID, TEST, "an-invalid-credentials-id"))
                        .then()
                        .statusCode(404)
        ...
        class ValidateWorldpayCredentials {
            ...
            void forNonExistentGatewayAccount_shouldReturn404() {
                app.givenSetup()
                        ...
                        .post(format(VALIDATE_CREDENTIALS_BY_SERVICE_ID_URL, VALID_SERVICE_ID, TEST))
                        .then()
                        .statusCode(404)
