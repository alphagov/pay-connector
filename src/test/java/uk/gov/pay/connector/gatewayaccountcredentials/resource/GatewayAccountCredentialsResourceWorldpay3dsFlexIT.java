...
public class GatewayAccountCredentialsResourceWorldpay3dsFlexIT {
    ...
    class ByAccountId {
        ...
        class ValidateWorldpay3dsCredentials {
            ...
            void forAccountSwitchingToWorldpay_withValidCredentials_shouldReturn200_withResultValid() throws Exception {
                var anAccountId = secureRandomLong(2, 10000);
                ...
                givenSetup()
                        .body(getCheck3dsConfigPayloadForValidCredentials())
                        .post(format(VALIDATE_3DS_FLEX_CREDENTIALS_URL, anAccount.getAccountId()))
                        .then()
                        .statusCode(200)
                        .body("result", is("valid"));
            }
    ...
    class ByServiceIdAndAccountType {
        @Nested
        class CreateOrUpdateWorldpay3DSCredentials {
            @Test
        ...
        class ValidateWorldpay3dsCredentials {
            ...
            void forValidCredentials_shouldReturn200_withResultValid() {
                ...
                app.givenSetup()
                        .body(toJson(valid3dsFlexCredentialsPayload))
                        .post(format("/v1/api/service/%s/account/%s/worldpay/check-3ds-flex-config", SERVICE_ID, TEST))
                        .then()
                        .statusCode(200)
                        .body("result", is("valid"));
            }
    ...
    private AddGatewayAccountCredentialsParams createGatewayAccountCredentialsParams(long accountId, String paymentProvider, GatewayAccountCredentialState state) {
        ...
        return anAddGatewayAccountCredentialsParams()
