...
import static uk.gov.pay.connector.paymentprocessor.service.CaptureProcessScheduler.*;

@RunWith(MockitoJUnitRunner.class)
public class SQSMessageReceiverHandlerTest {

    @Mock
    private SQSMessageReceiverHandler 
