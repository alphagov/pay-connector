...
public class TransactionsApiResourceITest extends ChargingITestBase {
     ...
     */
    @Test
    public void shouldGetExpectedTransactionsByChargeReferenceAndStatuses() {
        ...
        ValidatableResponse validatableResponse = getChargeApi
        ...
        System.out.println("validatableResponse.extract().body().asString() = " + validatableResponse.extract().body().asString());
