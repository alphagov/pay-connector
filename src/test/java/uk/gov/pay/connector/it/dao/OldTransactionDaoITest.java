...
public class OldTransactionDaoITest extends DaoITestBase {
    ...
    public void setupAccountWithOneChargeAndRefundForTheCharge() {
        oldTransactionDao = env.getInstance(OldTransactionDao.class);
    ...
    public void shouldGetExpectedTotalCount() {
        ...
        // when
        Long count = oldTransactionDao.getTotalFor(defaultTestAccount.getAccountId(), params);
