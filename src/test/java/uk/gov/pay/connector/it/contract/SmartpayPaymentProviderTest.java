...
public class SmartpayPaymentProviderTest {
    ...
    public void shouldSendA3dsOrderForMerchantSuccessfully() throws Exception {
        ...
        PaymentProvider paymentProvider = getSmartpayPaymentProvider();
        BaseAuthorisationGatewayRequest request = getCard3dsAuthorisationRequest(chargeEntity);
    ...
    public void shouldFailRequestAuthorisationIfCredentialsAreNotCorrect() throws Exception {
        ...
        BaseAuthorisationGatewayRequest request = getCardAuthorisationRequest(chargeEntity);
        GatewayResponse<SmartpayAuthorisationResponse> response = paymentProvider.authorise(request);
    ...
    public static BaseAuthorisationGatewayRequest getCardAuthorisationRequest(ChargeEntity chargeEntity) {
    ...
    public static BaseAuthorisationGatewayRequest getCard3dsAuthorisationRequest(ChargeEntity chargeEntity) {
