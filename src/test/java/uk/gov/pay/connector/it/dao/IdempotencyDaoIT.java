...
public class IdempotencyDaoIT extends DaoITestBase {
    ...
    private Map<String, Object> requestBody = Map.of("amount", 100L);
    ...
    public void shouldThrowException_whenGatewayAccountIdAndKeyExists() {
        IdempotencyEntity entity = new IdempotencyEntity(key, gatewayAccount, resourceExternalId, requestBody, Instant.now());
        dao.persist(entity);
