...
public final class GatewayAccountEntityFixture {
    ...
    public GatewayAccountEntity build() {
        ...
        gatewayAccountEntity.getCardConfigurationEntity().setRequires3ds(requires3ds);
        gatewayAccountEntity.getCardConfigurationEntity().setAllowGooglePay(allowGooglePay);
        gatewayAccountEntity.getCardConfigurationEntity().setAllowApplePay(allowApplePay);
        gatewayAccountEntity.getCardConfigurationEntity().setCorporateCreditCardSurchargeAmount(corporateCreditCardSurchargeAmount);
        gatewayAccountEntity.getCardConfigurationEntity().setCorporateDebitCardSurchargeAmount(corporateDebitCardSurchargeAmount);
        gatewayAccountEntity.getCardConfigurationEntity().setCorporatePrepaidDebitCardSurchargeAmount(corporatePrepaidDebitCardSurchargeAmount);
        gatewayAccountEntity.setAllowZeroAmount(allowZeroAmount);
        gatewayAccountEntity.getCardConfigurationEntity().setIntegrationVersion3ds(integrationVersion3ds);
        ...
        gatewayAccountEntity.getCardConfigurationEntity().setSendPayerIpAddressToGateway(sendPayerIpAddressToGateway);
        gatewayAccountEntity.setProviderSwitchEnabled(providerSwitchEnabled);
        gatewayAccountEntity.getCardConfigurationEntity().setBlockPrepaidCards(blockPrepaidCards);
