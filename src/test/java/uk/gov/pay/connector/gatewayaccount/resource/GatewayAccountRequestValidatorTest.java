...
public class GatewayAccountRequestValidatorTest {
    ...
    @Parameters({
            ...
            "add, zzzzz, Field [credentials/gateway_merchant_id] value [zzzzz] does not match that expected for a Worldpay Merchant ID; characters should be within range [0-9a-f]",
