    ...
    static private Object[] invalidData() {
        return new Object[]{
                ...
                Map.of("operation", "add", "path", "blood_sample_deposited", "value", true,
                        "expectedErrorMessage", "Field [path] must be one of [bank_account, company_number, director, government_entity_document, organisation_details, responsible_person, vat_number]"),
