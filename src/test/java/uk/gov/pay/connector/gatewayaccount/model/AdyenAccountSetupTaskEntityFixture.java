...
public class AdyenAccountSetupTaskEntityFixture {
    ...
    public static AdyenAccountSetupTaskEntityFixture anAdyenAccountSetupTaskEntityFixture() {
        return new AdyenAccountSetupTaskEntityFixture();
    }

    public static ArrayList<AdyenAccountSetupTaskEntity> anAdyenAccountSetupTaskEntityListWithAllTasksCompleted(GatewayAccountEntity gatewayAccount, GatewayAccountCredentialsEntity gatewayAccountCredential) {
