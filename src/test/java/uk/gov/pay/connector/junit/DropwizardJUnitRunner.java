...
import static uk.gov.pay.connector.junit.PostgresTemplate.createTemplate;
import static uk.gov.pay.connector.junit.PostgresTemplate.restorePostgres;
...
public final class DropwizardJUnitRunner extends BlockJUnit4ClassRunner {
    ...
    public Object createTest() throws Exception {
        ...
        if (declaredConfiguration.withDockerPostgres()) {
            // Commenting this out as the following is thrown in tests:
