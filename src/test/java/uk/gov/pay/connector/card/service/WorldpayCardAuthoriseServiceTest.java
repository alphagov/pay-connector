...
class WorldpayCardAuthoriseServiceTest extends CardServiceTest {
    ...
    void setup() {
        ...
        ChargeService chargeService = new ChargeService(null, mockedChargeDao, mockedChargeEventDao,
                ...
                mock(EventService.class), mock(GatewayAccountCredentialsService.class),
                mockTaskQueueService, mockWorldpay3dsFlexJwtService, mock(IdempotencyDao.class),
        ...
        cardAuthorisationService = new CardAuthoriseService(
                ...
                chargeService,
                cardService, new AuthorisationLogger(new AuthorisationRequestSummaryStringifier(), new AuthorisationRequestSummaryStructuredLogging()),
