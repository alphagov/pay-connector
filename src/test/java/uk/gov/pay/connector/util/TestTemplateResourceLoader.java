...
public class TestTemplateResourceLoader {
    ...
    public static final String WORLDPAY_VALID_AUTHORISE_WORLDPAY_REQUEST_SETUP_AGREEMENT_WITH_RECURRING_AGREEMENT_PAYMENT_TYPE = WORLDPAY_BASE_NAME + "/valid-authorise-worldpay-request-setup-agreement-with-recurring-agreement-payment-type.xml";
    public static final String WORLDPAY_VALID_AUTHORISE_WORLDPAY_REQUEST_SETUP_AGREEMENT_WITH_INSTALMENT_AGREEMENT_PAYMENT_TYPE = WORLDPAY_BASE_NAME + "/valid-authorise-worldpay-request-setup-agreement-with-instalment-agreement-payment-type.xml";
    public static final String WORLDPAY_VALID_AUTHORISE_WORLDPAY_REQUEST_SETUP_AGREEMENT_WITH_UNSCHEDULED_AGREEMENT_PAYMENT_TYPE = WORLDPAY_BASE_NAME + "/valid-authorise-worldpay-request-setup-agreement-with-unscheduled-agreement-payment-type.xml";
