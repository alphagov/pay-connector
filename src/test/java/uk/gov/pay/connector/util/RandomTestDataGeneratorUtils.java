...
public final class RandomTestDataGeneratorUtils {
    ...
    public static String randomAlphabetic(int length) {
        return randomFromCharacters(CHARS, length);
    }

    public static String randomAlphanumeric(int length) {
        return randomFromCharacters(ALPHA_NUM, length);
    }

    private static String randomFromCharacters(String possibleCharacters, int length) {
