...
public abstract class BaseEpdqPaymentProviderTest {
    ...
    AuthorisationGatewayRequestImpl buildTestAuthorisationRequest(ChargeEntity chargeEntity) {
        return new AuthorisationGatewayRequestImpl(chargeEntity, buildTestAuthCardDetails());
    }
    ...
    AuthorisationGatewayRequestImpl buildTestAuthorisationRequest() {
    ...
    private AuthorisationGatewayRequestImpl buildTestAuthorisationRequest(GatewayAccountEntity accountEntity) {
        ChargeEntity chargeEntity = aValidChargeEntity()
                .withExternalId("mq4ht90j2oir6am585afk58kml")
