...
class AdyenAuthoriseHandlerTest {
    ...
    @Test
    void should_send_request_to_Adyen_for_recurring_payment() throws GatewayException.GatewayErrorException, GatewayException.GenericGatewayException, GatewayException.GatewayConnectionTimeoutException {
        givenAdyenReturnsASuccessResponse();
    ...
    @Test
    void should_not_authorise_recurring_payment_when_payment_provider_returns_unexpected_status_code() throws Exception {
        givenAdyenReturnsAnUnexpectedResponse();
        var agreementId = "some-agreement-id";
        var agreement = anAgreementEntity()
                .withExternalId(agreementId)
