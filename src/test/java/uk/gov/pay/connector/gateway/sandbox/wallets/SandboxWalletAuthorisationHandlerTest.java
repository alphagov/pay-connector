...
class SandboxWalletAuthorisationHandlerTest {
    ...
    @Test
    void authorise_shouldBeAuthorisedWhenChargeDescriptionIsNotMagicValue_forGooglePay() {
        GooglePayAuthRequest googlePayAuthRequest =
                aGooglePayAuthRequest()
                        .withGooglePaymentInfo(
                                aGooglePayPaymentInfo()
                                        .withLastDigitsCardNumber("1234")
                                        .build())
                        .build();
    ...
    @ParameterizedTest
    @EnumSource(value = SandboxWalletMagicValues.class, names = {"DECLINED", "REFUSED"})
    void authorise_shouldNotBeAuthorisedWithAnyLastDigitsCardNumbersWhenMagicValuesArePresent_forGooglePay(SandboxWalletMagicValues magicValue) {
        GooglePayAuthRequest googlePayAuthRequest =
                aGooglePayAuthRequest()
                        .withGooglePaymentInfo(
                                aGooglePayPaymentInfo()
    ...
    @Test
    void authorise_shouldGetGatewayErrorWithAnyLastDigitsCardNumbersWhenMagicValueIsPresent_forGooglePay() {
        GooglePayAuthRequest googlePayAuthRequest =
                aGooglePayAuthRequest()
                        .withGooglePaymentInfo(
                                aGooglePayPaymentInfo()
