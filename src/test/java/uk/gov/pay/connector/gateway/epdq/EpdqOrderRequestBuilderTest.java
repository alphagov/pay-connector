...
import static uk.gov.pay.connector.util.TestTemplateResourceLoader.EPDQ_AUTHORISATION_REQUEST_WITHOUT_ADDRESS;
...
public class EpdqOrderRequestBuilderTest {
    ...
    @Test
    public void shouldGenerateValidAuthoriseOrderRequestWhenAddressIsMissing() {
        AuthCardDetails authCardDetails = AuthUtils.buildAuthCardDetails("Mr. Payment", "5555444433331111", "737", "08/18", "visa", null);
        ...
        assertEquals(TestTemplateResourceLoader.load(EPDQ_AUTHORISATION_REQUEST_WITHOUT_ADDRESS), actualRequest.getPayload());
        assertEquals(OrderRequestType.AUTHORISE, actualRequest.getOrderRequestType());
    }
