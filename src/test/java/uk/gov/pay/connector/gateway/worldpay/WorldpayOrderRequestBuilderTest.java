...
class WorldpayOrderRequestBuilderTest {
    ...
    @CsvSource(useHeadersInDisplayName = true, nullValues = "null", textBlock = """
            3ds_enabled, send_payer_ip_address_to_gateway, send_payer_email_to_gateway, email_address, is_moto, template_path
            true, true, true, citizen@example.org, false, templates/worldpay/valid-authorise-worldpay-request-including-3ds-with-email-and-ip.xml
            true, false, true, test@email.invalid, false, templates/worldpay/valid-authorise-worldpay-request-including-3ds-with-email.xml
            true, true, false, citizen@example.org, false, templates/worldpay/valid-authorise-worldpay-request-including-3ds-with-ip-address.xml
            true, false, false, citizen@example.org, false, templates/worldpay/valid-authorise-worldpay-request-including-3ds.xml
            false, true, true, citizen@example.org, false, templates/worldpay/valid-authorise-worldpay-request-excluding-3ds.xml
            false, true, true, null, false, templates/worldpay/valid-authorise-worldpay-request-excluding-3ds.xml
            """)
    void testVariationsOfSendPayerEmailAndSendPayerIPAddress(boolean is3dsEnabled, boolean sendIPAddress, boolean sendEmail, String emailAddress, boolean isMoto, String testTemplatePath) throws IOException, SAXException {
        ...
        if (sendEmail && is3dsEnabled) {
            builder.withPayerEmail(emailAddress);
        }
        
        if (sendIPAddress && is3dsEnabled) {
