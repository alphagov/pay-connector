...
class AuthorisationRequestSummaryStructuredLoggingTest {
    ...
    is_billing_address_present, payer_email, ip_address, three_ds_required
    true, citizen@example.org, 1.1.1.1, true
    false, null, null, false
    """)
    void createArgsForPreAuthorisationLogging(boolean isBillingAddressPresent, String payerEmail, String ipAddress, boolean isThreeDsRequired) {
        ...
        StructuredArgument[] result = structuredLogging.createArgsForPreAuthorisationLogging(mockOrderRequestBuilder, mockAuthCardDetails);
