...
public class StripeNotificationServiceTest {
    ...
    public void shouldUpdateCharge_WhenNotificationIsFor3DSSourceChargeable() {
        ...
        verify(mockCard3dsResponseAuthService).process3DSecureAuthorisationWithoutLocking(externalId, getAuth3dsDetails(Auth3dsDetails.Auth3dsResultOutcome.AUTHORISED));
    }
    ...
    public void shouldUpdateCharge_WhenNotificationIsFor3DSSourceFailed() {
        ...
        verify(mockCard3dsResponseAuthService).process3DSecureAuthorisationWithoutLocking(externalId, getAuth3dsDetails(Auth3dsDetails.Auth3dsResultOutcome.DECLINED));
    }
    ...
    public void shouldUpdateCharge_WhenNotificationIsFor3DSSourceCancelled() {
        ...
        verify(mockCard3dsResponseAuthService).process3DSecureAuthorisationWithoutLocking(externalId, getAuth3dsDetails(Auth3dsDetails.Auth3dsResultOutcome.CANCELED));
    } 
    ...
    private Auth3dsDetails getAuth3dsDetails(Auth3dsDetails.Auth3dsResultOutcome auth3DsResultOutcome) {
