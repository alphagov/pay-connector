...
class WorldpayOrderBuilderTest {
    ...
    @CsvSource(useHeadersInDisplayName = true, nullValues = "null", textBlock = """
            3ds_enabled, send_payer_email_to_gateway, send_payer_ip_address_to_gateway, email_address, is_moto, three_ds_flex_ddc_result, include_email, include_ip
            ...
            """)
    void testVariationsOfSendPayerEmailAndSendPayerIPAddress(boolean is3dsEnabled, boolean sendEmail, boolean sendIPAddress, String emailAddress, boolean isMoto,
                                                             String threeDsFlexDdcResult, boolean includeEmail, boolean includeIP) {
