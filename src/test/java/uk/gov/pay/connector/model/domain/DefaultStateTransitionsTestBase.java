...
public class DefaultStateTransitionsTestBase {
    ...
    public static Collection<Object[]> setParameters() {
        ...
        params.add(new Object[]{AUTHORISATION_READY, of(AUTHORISATION_SUCCESS, AUTHORISATION_REJECTED, AUTHORISATION_ERROR, AUTHORISATION_3DS_REQUIRED, AUTHORISATION_CANCELLED)});
        ...
        params.add(new Object[]{CAPTURE_APPROVED, of(CAPTURE_READY)});
        params.add(new Object[]{CAPTURE_READY, of(CAPTURE_SUBMITTED, CAPTURE_ERROR, CAPTURE_APPROVED)});
