...
public class DefaultStateTransitionsTestBase {
    ...
    public static Collection<Object[]> setParameters() {
        ...
        params.add(new Object[]{AUTHORISATION_SUBMITTED, of(AUTHORISATION_SUCCESS, AUTHORISATION_REJECTED, AUTHORISATION_ERROR, AUTHORISATION_3DS_REQUIRED, AUTHORISATION_CANCELLED)});
