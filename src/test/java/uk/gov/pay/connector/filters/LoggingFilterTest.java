...
public class LoggingFilterTest {
    ...
    public void shouldLogEntryAndExitPointsOfEndPoints() throws Exception {
        ...
        assertThat(loggingEvents.get(0).getFormattedMessage(), is("Start - connector request - " + requestUrl));
        assertThat(loggingEvents.get(1).getFormattedMessage(), is("End - connector request - " + requestUrl));
    ...
    public void shouldLogEntryAndExitPointsEvenWhenFilterChainingThrowsException() throws Exception {
        ...
        assertThat(loggingEvents.get(2).getFormattedMessage(), is("End - connector request - "+ requestUrl));
    }
