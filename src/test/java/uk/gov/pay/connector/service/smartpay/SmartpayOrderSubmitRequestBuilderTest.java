...
public class SmartpayOrderSubmitRequestBuilderTest {
    ...
    @Test
    public void shouldGenerateValidOrderSubmitPayload_ForAddressWith_OptionalFieldsMissing() throws Exception {
        ...
        assertXMLEqual(expectedOrderSubmitPayload("valid-order-submit-smartpay-request-minimal.xml"), actualRequest);
    }
