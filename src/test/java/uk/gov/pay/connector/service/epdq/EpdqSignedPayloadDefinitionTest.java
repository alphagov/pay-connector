...
import uk.gov.pay.connector.service.epdq.EpdqOrderRequestBuilder.EpdqTemplateData;
...
public class EpdqSignedPayloadDefinitionTest {
    ...
    private static final String PASSPHRASE = "my super-secret passphrase";
    ...
    public void shouldDecoratePayloadDefinitionWithSignature() {
        ...
        when(mockEpdqTemplateData.getShaPassphrase()).thenReturn(PASSPHRASE);
        when(mockSignatureGenerator.sign(ImmutableList.of(PARAM_1, PARAM_2, PARAM_3), PASSPHRASE)).thenReturn(SIGNATURE);
