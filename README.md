...
Config files include declarations for test URLs for balancePlatform, legalEntityManagement and management. These are required and overridden in integration tests only, and do not require values to be set. 
