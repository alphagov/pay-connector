...
| Variable                                                    | Default                                      | Purpose                                                                                                                                                                                   |
|-------------------------------------------------------------|----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `GDS_CONNECTOR_ADYEN_BASE_URL_CHECKOUT_TEST`                | `https://checkout-test.adyen.com/v72`        | Checkout API base URL for test accounts                                                                                                                                                   |
| `GDS_CONNECTOR_ADYEN_BASE_URL_CHECKOUT_LIVE`                |                                              | Checkout API base URL for live accounts                                                                                                                                                   |
| `GDS_CONNECTOR_ADYEN_BASE_URL_BALANCE_PLATFORM_TEST`        | `https://balanceplatform-api-test.adyen.com` | Balance Platform API base URL for test                                                                                                                                                    |
| `GDS_CONNECTOR_ADYEN_BASE_URL_BALANCE_PLATFORM_LIVE`        |                                              | Balance Platform API base URL for live                                                                                                                                                    |
| `GDS_CONNECTOR_ADYEN_BASE_URL_LEGAL_ENTITY_MANAGEMENT_TEST` | `https://kyc-test.adyen.com/lem/v4`          | Legal Entity Management API base URL for test                                                                                                                                             |
| `GDS_CONNECTOR_ADYEN_BASE_URL_LEGAL_ENTITY_MANAGEMENT_LIVE` |                                              | Legal Entity Management API base URL for live                                                                                                                                             |
| `GDS_CONNECTOR_ADYEN_BASE_URL_MANAGEMENT_TEST`              | `https://management-test.adyen.com/v3`       | Management API base URL for test                                                                                                                                                          |
| `GDS_CONNECTOR_ADYEN_BASE_URL_MANAGEMENT_LIVE`              |                                              | Management API base URL for live                                                                                                                                                          |
