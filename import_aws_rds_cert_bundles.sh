...
# The cert bundles distributed by AWS are bundles which contain multiple CA cert chains. The keytool command can only
# import a single cert/chain, and will silently import the first and ignore the rest. So we need to break the bundle up
# into individual certs and then import them individually.
#
...
# Finally import the old 2019 CA Cert bundles
...
# Finally import the old 2019 CA certs
